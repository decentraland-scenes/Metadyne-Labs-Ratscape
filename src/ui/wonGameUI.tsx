...
import { Color4 } from '@dcl/sdk/math'
  ...
  export function createWonGameUI(){
    return (
      
      <UiEntity key={"wongameui"}
        uiTransform={{
          width: calculateImageDimensions(50, 1.78).width,
          height: calculateImageDimensions(50, 1.78).height,
          flexDirection:'column',
          display: displays.active === "wongame" ? 'flex' : 'none',
          alignContent:'center',
...
<UiEntity
    uiTransform={{
      width: calculateImageDimensions(35,832/344).width,
      height: calculateImageDimensions(35,832/344).height,
      alignSelf:'center',
      flexDirection:'column',
      justifyContent:'center',
      alignContent:'center'
